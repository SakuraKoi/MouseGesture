# Mouse Gesture Extension - Licensing
...
### 🆓 GPL v3 (Free)
- **Free for:** Open-source, personal, educational use
- **Requirement:** Derivative works must also be GPL v3
- **Source code:** Must be provided when distributing

### 💼 Commercial License
- **For:** Proprietary and commercial applications
- **Benefit:** No GPL copyleft requirements
- **Contact:** license@cgqa.com for licensing
...
**Licensing inquiries:** license@cgqa.com

---

*This project uses a dual licensing model to support both open-source and commercial use cases.* 